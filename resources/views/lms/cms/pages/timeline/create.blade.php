...
@section('content')
    <section class="section">
        <div class="card-body">
            {{ Form::open(['url' => route('timelines.store')]) }}
            ...
            <input type="hidden" name="for_page" value="timelines">
            <div class="form-group">
                <strong class="d-inline-block mb-2">Choose Section</strong>
                <select id="timelineSelect" class="js-example-basic-single w-100">
                    <option></option>
                    @foreach (trans('translation.time_line_inner') as $key => $data)
